package com.yd.telescopeapi.scheduled;
...
//        String activityPath = "E:\\Document\\acitivity.txt";
        String activityPath = "/u02/telescopetest/Document/acitivity.txt";
//        String fragmentPath = "E:\\Document\\fragment.txt";
        String fragmentPath = "/u02/telescopetest/Document/fragment.txt";
...
//    @Scheduled(cron = "0/30 * * * * ?")
    public void getBug() throws Exception {
        ...
        for (i = 1; i <= 2; i++) {
            ...
            String bugPath = "/u02/telescopetest/Document/" + random.nextInt(6) + ".txt";
